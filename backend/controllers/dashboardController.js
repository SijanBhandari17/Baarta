...
const handleDashBoard = async (req , res)=>{
    ...
    res.status(200).json({'messsage' : `access granted`,
    'info' : {
        username : req.user.username,
        email : req.user.email,
        profilePic : profile?.profilePicLink || 'https://res.cloudinary.com/dlddcx3uw/image/upload/v1752323363/defaultUser_cfqyxq.svg'
    }
    })
}
